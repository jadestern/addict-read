...
export function Toast({ id, type, message, duration = 3000, onRemove }: ToastProps) {
  ...
  const getToastStyles = () => {
    const baseStyles = "flex items-center gap-3 p-4 rounded-lg shadow-lg border min-w-80 max-w-md";
